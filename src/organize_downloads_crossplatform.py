#!/usr/bin/env python3
"""
Downloads Folder Organizer - Cross-Platform Version
...
from platform_utils import get_downloads_path, get_log_file
...
def organize_downloads():
    ...
    for item in downloads_path.iterdir():
        if item.is_file():
            ...
            # Skip files that might be in the root for a reason
            # (we don't need to skip organizer scripts anymore since they're not in Downloads)
...
def main():
    ...
    print("Downloads Folder Organizer - Cross-Platform")
    print("=" * 50)
    print(f"Platform: {os.name}")
    print(f"Downloads folder: {get_downloads_path()}")
