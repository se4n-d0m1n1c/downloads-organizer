...
case $choice in
    ...
    5)
        ...
        echo "   python3 $PROJECT_PATH/src/organize_downloads_cron.py"
        echo ""
        echo "2. To run manually anytime (interactive):"
        echo "   python3 $PROJECT_PATH/src/organize_downloads.py"
        echo ""
        echo "3. To add a cron job (edit schedule as needed):"
        echo "   crontab -e"
        echo "   Add this line for daily at 6 PM:"
        echo "   0 18 * * * $(which python3) $PROJECT_PATH/src/organize_downloads_cron.py"
        echo ""
        echo "4. To run real-time watcher:"
        echo "   $PROJECT_PATH/scripts/watch_downloads.sh"
        echo "   (Run in background: nohup $PROJECT_PATH/scripts/watch_downloads.sh &)"
        echo ""
        echo "5. Log files:"
        ...
        echo "   alias organize-downloads='python3 $PROJECT_PATH/src/organize_downloads.py'"
        echo "   alias watch-downloads='nohup $PROJECT_PATH/scripts/watch_downloads.sh &'"
        ;;
